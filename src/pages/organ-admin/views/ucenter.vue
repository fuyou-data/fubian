<template>
  <div class="center-box">
    ...
    <div class="type">账号属性：部门管理员</div>
    <div class="amend" @click="dialogVisible=true">
      <icon-font name="#mdd-edit" :width="14" :height="14" color="34B7B9"> </icon-font>
    修改密码</div>
    <el-dialog  width="500px" center class="myDialog" :show-close="false" :close-on-click-modal="false"
      custom-class="{border-radius:50px}" :close-on-press-escape="false" :visible.sync="dialogVisible">
      <template slot="title">
        <div style="text-align: left;font-size:18px;color:#34B7B9;font-weight:700">修改密码</div>
      </template>
      <el-form  label-width="150px" label-position="right" ref="myForm"  :rules="rules" :model="myForm" status-icon  v-show="editFlag">
          <el-row>
     ...
     <div class="successShow" v-show="reverseFlag">
      <icon-font name="#mdd-zhuangtaizhengque" :width="90" :height="90" color="34B7B9"> </icon-font>
      <p>密码修改成功!</p>
      <div>
